...
The preset and colors you pick during init don't matter — the material design theme replaces them in the next step. For details on initializing shadcn-svelte, visit the <a href="https://www.shadcn-svelte.com/docs/installation" target="_blank" rel="noopener noreferrer">shadcn-svelte docs</a>.
...
<CodeBlock source={`npm install @fontsource-variable/roboto @fontsource-variable/geist-mono`} />

Then import them in your global stylesheet, replacing the font import added by `shadcn-svelte init`:

<CodeBlock source={"@import '@fontsource-variable/roboto';\n@import '@fontsource-variable/geist-mono';"} />
